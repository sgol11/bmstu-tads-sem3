...
void print_table(car_t *cars, int n)
{
    ...
    printf("| №   | Марка машины    | Страна          | Цена       | Цвет            | Состояние "
           "| Гарантия | Год     | Пробег    | Количество | Количество    |\n");
    printf("|     |                 |                 |            |                 |           "
           "|          | выпуска |           | ремонтов   | собственников |\n");
    printf("|-----|-----------------|-----------------|------------|-----------------|-----------"
           "|----------|---------|-----------|------------|---------------|\n");
    for (int i = 0; i < n; i++)
    {
        printf("| %-3d | %-15s | %-15s | %-10d | %-15s ", i + 1, cars[i].brand, cars[i].country, 
